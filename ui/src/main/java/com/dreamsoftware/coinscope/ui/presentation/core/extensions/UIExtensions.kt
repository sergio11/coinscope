package com.dreamsoftware.coinscope.ui.presentation.core.extensions
...
fun Double.toDisplayableNumber(): DisplayableNumberVO {
    val formatter = NumberFormat.getNumberInstance(Locale.getDefault()).apply {
        minimumFractionDigits = 2
        maximumFractionDigits = 2
    }
    return DisplayableNumberVO(
        value = this,
...
fun String.symbolToCoinDrawable(): Int = when (uppercase()) {
