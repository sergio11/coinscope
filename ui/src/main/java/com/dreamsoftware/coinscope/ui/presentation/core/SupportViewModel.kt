...
abstract class SupportViewModel<STATE : UiState<STATE>, EFFECT : SideEffect>(
     ...
     */
    protected suspend fun <RESULT, UC : SupportUseCase<RESULT>> executeUseCase(
        useCase: UC,
     ...
     * @param showLoadingState A boolean indicating if the loading state should be shown (default is true).
     */
    protected fun <RESULT, UC : SupportUseCase<RESULT>> executeUseCase(
        useCase: UC,
     ...
     * @return The result of the use case execution.
     */
    protected suspend fun <PARAMS, RESULT, UC : SupportUseCaseWithParams<PARAMS, RESULT>> executeUseCaseWithParams(
        useCase: UC,
        params: PARAMS,
        onMapExceptionToState: ((Exception, STATE) -> STATE)? = null,
        onGetDefaultValue: () -> RESULT,
     ...
     * @param showLoadingState A boolean indicating if the loading state should be shown (default is true).
     */
    protected fun <PARAMS, RESULT, UC : SupportUseCaseWithParams<PARAMS, RESULT>> executeUseCaseWithParams(
        useCase: UC,
        params: PARAMS,
        onSuccess: (RESULT) -> Unit = {},
        onFailed: () -> Unit = {},
